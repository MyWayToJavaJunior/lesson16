...
public class User implements Runnable{
    ...
    public void run() {
        ...
        for (int i = 0; i < 520; i++) {
            ...
            if (!controller.renamePerson(getPName, getNewPName)) {
        ...
        Main.log.append("Passed: ").append((timer) / 1000).append(" sec (User)\n");
        Main.log.append("Operations failed: ").append(failCount).append(" times (User)\n");
        Main.cld.countDown();
    }
