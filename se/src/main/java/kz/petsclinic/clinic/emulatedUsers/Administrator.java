...
public class Administrator implements Runnable{
    ...
    public void run() {
        ...
        Main.log.append("Passed: ").append((timer)/1000).append(" sec (Administrator)\n");
        Main.log.append("Operations failed: ").append(failCount).append(" times (Administrator)\n");
        Main.cld.countDown();
    }
